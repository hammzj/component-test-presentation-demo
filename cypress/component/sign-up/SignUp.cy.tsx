...
describe('SignUp', function () {
    ...
    context('element existence', function () {
        ...
        it.only('has the company logo', function () {
        ...
        context('sign-up form', function () {
            ...
            validations.forEach(v => {
                it(`has a field for "${v.label}"`, function () {
                    ...
                    //Test label
                    cy.get('[data-testid="sign-up"]').find(v.inputSelector)
            ...
            it('has a submit button', function () {
                cy.get('[data-testid="sign-up"]').contains('button[type=submit]', 'Sign up').should('exist')
            })
        })
        ...
        context('additional sign-up options', function () {
            ...
            it('has a sign up button with a Google account', function () {
                ...
                cy.contains('button', 'Sign up with Google').find('svg#google-icon').should('exist')
            })
            ...
            it('has a sign up button with a Facebook account', function () {
                ...
                cy.contains('button', 'Sign up with Facebook').find('svg#facebook-icon').should('exist')
    ...
    context('state management', function () {
        it('captures data when submitting the form', function () {
            ...
            valueSets.forEach(values => {
                ...
                if (values.allowExtraEmails) cy.get('input[name=allowExtraEmails]').parent().click()
                cy.contains('button', 'Sign up').click()
