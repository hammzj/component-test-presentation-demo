...
import { brand, brown, gray, green, red } from "../theme";
...
const getDesignTokens = (mode: PaletteMode) => ({
    palette: {
        ...
        background: {
            default: gray[50],
            paper: gray[100],
            ...(mode === "dark" && { default: gray[700], paper: gray[800] }),
        },
        text: {
            primary: gray[800],
            secondary: gray[600],
            ...
            MuiAlert: {
                styleOverrides: {
                    root: ({ theme }) => ({
                        ...
                        border: `1px solid ${alpha(brown[300], 0.5)}`,
                        "& .MuiAlert-icon": {
                            color: brown[500],
                        },
                        ...theme.applyStyles("dark", {
                            backgroundColor: `${alpha(brown[900], 0.5)}`,
                            border: `1px solid ${alpha(brown[800], 0.5)}`,
                        }),
                    }),
                },
            },
